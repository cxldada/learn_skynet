...
static int sp_create() { return kqueue(); }

static void sp_release(int kfd) { close(kfd); }
...
static int sp_enable(int kfd, int sock, void* ud, bool read_enable, bool write_enable) {
    int ret = 0;
    struct kevent ke;
