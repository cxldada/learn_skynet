...
void skynet_socket_nodelay(struct skynet_context* ctx, int id) { socket_server_nodelay(SOCKET_SERVER, id); }
...
struct socket_info* skynet_socket_info() { return socket_server_info(SOCKET_SERVER); }
